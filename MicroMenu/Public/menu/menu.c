 ...
 * @return     int
 */
int cotMenu_Bind(MenuList_t *pMenuList, menusize_t menuNum, ShowMenuCallFun_f pfnShowMenuFun)
{
    if (sg_tMenuManage.pMenuCtrl == NULL)
    {
        return -1;
 ...
 * @return     0,成功; -1,失败
 */
int cotMenu_LimitShowListNum(MenuShow_t *ptMenuShow, menusize_t *pShowNum)
{
 ...
 * @return int
 */
int cotMenu_QueryParentMenu(MenuShow_t *ptMenuShow, uint8_t level)
{
    int i;
    MenuList_t *pMenu;
    MenuCtrl_t *pMenuCtrl = NULL;
